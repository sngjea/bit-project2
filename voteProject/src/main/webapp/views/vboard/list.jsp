            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="http://192.168.0.55:9999/voteProject/vboard/list.do" class="btn btn-default">Cancel</a>
        ...
        <div class="modal fade" id="myModa3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="http://192.168.0.55:9999/voteProject/vboard/list.do" id="cancelBtn" class="btn btn-default">Cancel</a>
...
// 	  alert("되나?");
	$.ajax('http://192.168.0.55:9999/voteProject/vboard/replyDetail.do?vno='+no, {
	    method: 'get',
	    dataType: 'json',
...
// 	alert(no);
	$.ajax('http://192.168.0.55/voteProject/vboard/replyAdd.do?vno='+ no, {
	    method: 'POST',
	    dataType: 'json',
	    data: {
...
// 	alert(no1);
	...
	$.ajax('http://192.168.0.55:9999/voteProject/vboard/replyDelete.do?rno='+ no, {
	    method: 'GET',
	    dataType: 'json',
	    success: function(result) {
	    	replyBtn(no1);
...
// 	alert("업데이트");
	$.ajax('http://192.168.0.55:9999/voteProject/vboard/replyChange.do' , {
	      method: 'get',
	      dataType: 'json',
	      data: {
